...
async def button(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if query.data == 'lang_en':
        ...
        text = "हिंदी में: सभी उपयोगकर्ता एक नया खाता बनाएं और पंजीकरण करें। रजिस्ट्रेशन के बाद आपको नीचे फोटो में दिखाए अनुसार ₹200, ₹500 जमा करने होंगे और अपनी हैक फोटो और GoaGame फोटो नीचे दी गई आईडी पर भेजनी होगी फिर आपको hack key 🔐 दिया जायगा ।"
